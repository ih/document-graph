...
Meteor.startup(function () {
  ...
  generateDocumentationNode('how-to-link', 'Linking Instructions');
  generateDocumentationNode('welcome', 'Welcome!');

  function generateDocumentationNode(nodeId, title) {
    if (!Nodes.findOne({_id: nodeId})) {
      ...
      var nodeData = {
        ...
        editedAt: Utility.makeTimeStamp(),
        hasBeenSaved: true
      };

      Nodes.insert(nodeData);
